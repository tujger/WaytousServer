...
public class GroupSwitch extends AbstractAction<RequestWrapper> {
    ...
    public void call(JSONObject json, final RequestWrapper request) {
        ...
        request.processBody(buf -> {
            ...
            Common.getInstance().getDataProcessor().switchOptionInGroup(groupId,property, request::sendResult, jsonError -> request.sendError(500, jsonError));
        }, exception -> {
            Misc.err(GroupSwitch.this.getClass().getSimpleName(), exception);
